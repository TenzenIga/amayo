...
export class CreateSubFormComponent implements OnInit {
  ...
  public defaultIcon = 'url(https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y)'
  ...
  public fileValidator(control: AbstractControl): { [key: string]: any } | null {
    const file = control.value;
    if (!file) {
      return null; // File is optional unless you make it required
    }
